...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#text01', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 500, replay: false });
		onvisible.add('#container01', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 500, replay: false });
		onvisible.add('#container02', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 500, replay: false });
		onvisible.add('#container03', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 500, replay: false });
